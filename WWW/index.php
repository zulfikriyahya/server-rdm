...
define(
    'WIZARD_SUPPORT_TICKET_DEPARTMENT',
    '3'
);
define(
    'LOADER_FORUM_URL',
...
define(
    'LOADER_LATEST_VERSIONS_URL',
    LOADER_VERSION_URL . '?item=loader-versions'
);
define(
    'LOADER_PHP_VERSION_URL',
...
function calc_word_size($os_code)
{
    ...
    if ('win' === $os_code) {
        ...
        if (
            $compiler === 'VC9' || $compiler === 'VC11' || $compiler === 'VC14'
